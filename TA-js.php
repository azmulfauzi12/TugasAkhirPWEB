...
<body>
	<div class="all">
		...
		<div class="menu">
			<ul>
				<li><a href="http://localhost/Azmul/tugas%20akhir/TA-home.php"><p align="left">Home</p></a></li>
		...
		<div class="badan">			
			<div class="sidebar">
				<ul>
					<li><a href="http://localhost/Azmul/tugas%20akhir/TA-js.php">Javascript 1</a></li>
					<li><a href="http://localhost/Azmul/tugas%20akhir/TA-js1.php">Javascript 2</a></li>
